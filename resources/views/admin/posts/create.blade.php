...
@section("content")
    ...
    <div class="page-heading">
        ...
        <section class="section">
            <form id="create_post_form" action="{{ route("admin.posts.store") }}" class="form form-vertical" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="title" class="form-control" name="title" placeholder="Title *" value="{{ old("title") }}" autofocus>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="meta_keywords" class="form-control" name="meta_keywords" placeholder="Meta Keywords" value="{{ old("meta_keywords") }}">
                                    </div>
                                </div>
